    ...
    return(
        <div className="bg-[#E1FEFE] w-full h-[100vh]">
            <div className='flex flex-col gap-8 justify-center h-[100vh]'>
                <h1 className="text-[#333333] font-medium text-center text-2xl lg:text-4xl tracking-[5px]">Around the beauty</h1>
                <h3 className="text-[#BDBDBD] text-center uppercase tracking-[5px] font-semibold text-base lg:text-lg leading-5">Mountain / Costal / <span className="text-[#56CCF2]">Sea </span>/ Others</h3>
                <div className="lg:w-1/2 w-4/5 mx-auto h-[65vh]">
